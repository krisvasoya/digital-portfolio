    ...
    >
      ...
      <aside className="glass-panel flex-col layout-nav" style={{ gap: '2rem' }}>
        ...
        <nav className="flex-col" style={{ gap: '1rem' }}>
          ...
          <button className="cyber-btn flex-between" onClick={() => setActiveSection('overview')}>
            <span>Display Core</span> <Activity size={16} />
          </button>
          <button className="cyber-btn flex-between" onClick={() => setActiveSection('projects')}>
            <span>Projects</span> <Monitor size={16} />
          </button>
          <button className="cyber-btn flex-between" onClick={() => setActiveSection('skills')}>
            <span>Skills</span> <Cpu size={16} />
          </button>
          <button className="cyber-btn flex-between" onClick={() => setActiveSection('history')}>
            <span>About</span> <Activity size={16} />
          </button>
          <button className="cyber-btn flex-between" onClick={() => setActiveSection('contact')}>
            <span>Contact</span> <ShieldCheck size={16} />
          </button>
        </nav>
      </aside>
        ...
        {activeSection === 'overview' && (
          <motion.div 
            ...
            style={{ 
              ...
              pointerEvents: 'none',
              padding: '3rem 4rem',
              background: 'rgba(5, 8, 16, 0.85)', // Darker opacity for better contrast
